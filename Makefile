...
# Build flags
LDFLAGS := -X github.com/andpalmier/tfox/cmd.Version=$(VERSION) \
           -X github.com/andpalmier/tfox/cmd.Commit=$(COMMIT) \
           -X github.com/andpalmier/tfox/cmd.BuildDate=$(BUILD_DATE)
